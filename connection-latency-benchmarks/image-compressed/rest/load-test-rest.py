...
data_type = 'image-base64'
mode = 'equal' # options - step, equal, exponential

# single node inference
if platform == 'seldon':
    gateway_endpoint = "localhost:32000"
    deployment_name = 'latency-connection-rest-image-base64'
    model = 'mock-one'
    namespace = "default"
...
# ax.grid()
# fig.savefig(f"rest-compressed-image-{platform}_variant_{variant}-sending_time-load-{load}-test_duration-{test_duration}.png")
# plt.show()
